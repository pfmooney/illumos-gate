...
void
getrusage_proc(proc_t *p, struct rusage *r)
{
...
int
getrusage_chld(proc_t *p, struct rusage *r)
{
	hrtime_t snsecs, unsecs;
...
int
getrusage_curlwp(struct rusage *r)
{
...
rusagesys(int code, void *arg1, void *arg2, void *arg3, void *arg4)
{
	...
	case _RUSAGESYS_GETRUSAGE:
		getrusage_proc(curproc, &r);
		break;
	case _RUSAGESYS_GETRUSAGE_CHLD:
		getrusage_chld(curproc, &r);
		break;
	...
	/*
	 * Perform copyout for getrusage actions above
	 */
