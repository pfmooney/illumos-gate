 ...
 * corresponding control registers.  Post-F15h CPUs added an additional 2 CPU
 * counters, exposing them all through a new range of MSRs (with the original 4
 * counters aliasing onto the new ones, entries 0-3)
 *
 * Support for those newer extended counters is denoted by CPUID_AMD_ECX_PCEC in
 * function 0x80000001.
 */
#define	MSR_AMD_K7_PERF_EVSEL0	0xc0010000
#define	MSR_AMD_K7_PERF_EVSEL1	0xc0010001
#define	MSR_AMD_K7_PERF_EVSEL2	0xc0010002
#define	MSR_AMD_K7_PERF_EVSEL3	0xc0010003
...
#define	MSR_AMD_F15H_PERF_EVSEL0	0xc0010200
#define	MSR_AMD_F15H_PERF_EVSEL1	0xc0010202
#define	MSR_AMD_F15H_PERF_EVSEL2	0xc0010204
#define	MSR_AMD_F15H_PERF_EVSEL3	0xc0010206
#define	MSR_AMD_F15H_PERF_EVSEL4	0xc0010208
#define	MSR_AMD_F15H_PERF_EVSEL5	0xc001020a
...
#define	AMD_PERF_EVSEL_EVT_MASK		0xf000000ff	/* Event select bits */
#define	AMD_PERF_EVSEL_UNIT_MASK	0xff00		/* Unit mask */
#define	AMD_PERF_EVSEL_USER_MODE	(1 << 16)	/* User mode */
#define	AMD_PERF_EVSEL_OS_MODE		(1 << 17)	/* OS mode */
#define	AMD_PERF_EVSEL_EDGE		(1 << 18)	/* Edge detect */
#define	AMD_PERF_EVSEL_INT_EN		(1 << 20)	/* Interrupt enable */
#define	AMD_PERF_EVSEL_CTR_EN		(1 << 22)	/* Counter enable */
#define	AMD_PERF_EVSEL_INV_CMP		(1 << 23)	/* Invert comparison */
#define	AMD_PERF_EVSEL_CNT_MASK		0xff000000	/* Counter mask */
#define	AMD_PERF_EVSEL_HG_MASK		0x30000000000	/* Host/guest mask */

#define	AMD_PERF_EVSEL_HG_GUEST		0x10000000000	/* Guest-only */
#define	AMD_PERF_EVSEL_HG_HOST		0x20000000000	/* Host-only */
#define	AMD_PERF_EVSEL_HG_BOTH		0x30000000000	/* Guest and host */
